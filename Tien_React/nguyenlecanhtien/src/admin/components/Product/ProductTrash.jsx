...
export default function ProductTrash() {
  ...
  var allRevDel = document.querySelectorAll('.btn-remove');
  allRevDel.forEach((btnRemove => {
  ...
  var allRestoreBtn = document.querySelectorAll('.btn-store');
  allRestoreBtn.forEach((btnRestore => {
      ...
      products.map((product) => {
        return (
          <tr className="odd" key={product.id}>
            ...
            <td>{product.price}</td>
            <td>
              <i name={product.id} className="btn-restore  fas fa-trash-restore"></i>
              <i name={product.id} className="btn-remove fas fa-window-close"></i>
            </td>
          </tr>)
      })
